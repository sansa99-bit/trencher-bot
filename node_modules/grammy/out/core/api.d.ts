...
export declare class Api<R extends RawApi = RawApi> {
     ...
     */
    sendRichMessage(chat_id: number | string, rich_message: InputRichMessage, other?: Other<R, "sendRichMessage", "chat_id" | "rich_message">, signal?: AbortSignal): Promise<import("@grammyjs/types/message.js").Message.RichMessageMessage>;
    /**
     ...
     */
    sendRichMessageDraft(chat_id: number, draft_id: number, rich_message: InputRichMessageWithoutUpload, other?: Other<R, "sendRichMessageDraft", "chat_id" | "draft_id" | "rich_message">, signal?: AbortSignal): Promise<true>;
    /**
     ...
     */
    answerChatJoinRequestQuery(chat_join_request_query_id: string, result: "approve" | "decline" | "queue", signal?: AbortSignal): Promise<true>;
    /**
     ...
     */
    sendChatJoinRequestWebApp(chat_join_request_query_id: string, web_app_url: string, signal?: AbortSignal): Promise<true>;
    /**
     ...
     */
    editMessageText(chat_id: number | string, message_id: number, text_or_rich_message: string | InputRichMessage, other?: Other<R, "editMessageText", "chat_id" | "message_id" | "inline_message_id" | "text" | "rich_message">, signal?: AbortSignal): Promise<true | (import("@grammyjs/types/update.js").Update.Edited & import("@grammyjs/types/message.js").Message.CommonMessage & {
        text: string;
    } & Partial<{
        entities: import("@grammyjs/types/message.js").MessageEntity[];
    }>) | (import("@grammyjs/types/update.js").Update.Edited & import("@grammyjs/types/message.js").Message.CommonMessage & {
        rich_message: import("@grammyjs/types/message.js").RichMessage;
    })>;
    /**
     ...
     * **Official reference:** https://core.telegram.org/bots/api#editmessagetext
     */
    editMessageTextInline(inline_message_id: string, text_or_rich_message: string | InputRichMessage, other?: Other<R, "editMessageText", "chat_id" | "message_id" | "inline_message_id" | "text" | "rich_message">, signal?: AbortSignal): Promise<true | (import("@grammyjs/types/update.js").Update.Edited & import("@grammyjs/types/message.js").Message.CommonMessage & {
        text: string;
    } & Partial<{
        entities: import("@grammyjs/types/message.js").MessageEntity[];
    }>) | (import("@grammyjs/types/update.js").Update.Edited & import("@grammyjs/types/message.js").Message.CommonMessage & {
     ...
     */
    editEphemeralMessageText(chat_id: number | string, receiver_user_id: number, ephemeral_message_id: number, text_or_rich_message: string | InputRichMessage, other?: Other<R, "editEphemeralMessageText", "chat_id" | "receiver_user_id" | "ephemeral_message_id" | "text" | "rich_message">, signal?: AbortSignal): Promise<true>;
    /**
     ...
     */
    editEphemeralMessageMedia(chat_id: number | string, receiver_user_id: number, ephemeral_message_id: number, media: InputMedia, other?: Other<R, "editEphemeralMessageMedia", "chat_id" | "receiver_user_id" | "ephemeral_message_id" | "media">, signal?: AbortSignal): Promise<true>;
    /**
     ...
     */
    editEphemeralMessageCaption(chat_id: number | string, receiver_user_id: number, ephemeral_message_id: number, caption: string, other?: Other<R, "editEphemeralMessageCaption", "chat_id" | "receiver_user_id" | "ephemeral_message_id" | "caption">, signal?: AbortSignal): Promise<true>;
    /**
     ...
     * **Official reference:** https://core.telegram.org/bots/api#editephemeralmessagecaption
     */
    editEphemeralMessageReplyMarkup(chat_id: number | string, receiver_user_id: number, ephemeral_message_id: number, other?: Other<R, "editEphemeralMessageReplyMarkup", "chat_id" | "receiver_user_id" | "ephemeral_message_id">, signal?: AbortSignal): Promise<true>;
    /**
     ...
     */
    deleteEphemeralMessage(chat_id: number | string, receiver_user_id: number, ephemeral_message_id: number, signal?: AbortSignal): Promise<true>;
    /**
