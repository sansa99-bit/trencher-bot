...
export declare class Context implements RenamedUpdate {
    ...
    get stoppedMessageGeneration(): import("@grammyjs/types/message.js").MessageGenerationStopped | undefined;
    ...
    get subscription(): import("@grammyjs/types/manage.js").BotSubscriptionUpdated | undefined;
    /**
     ...
     */
    replyWithRichMessage(rich_message: InputRichMessage, other?: Other<"sendRichMessage", "chat_id" | "rich_message">, signal?: AbortSignal): Promise<Message.RichMessageMessage>;
    /**
     ...
     */
    replyWithMediaGroup(media: ReadonlyArray<InputMediaAudio> | ReadonlyArray<InputMediaDocument> | ReadonlyArray<InputMediaLivePhoto | InputMediaPhoto | InputMediaVideo>, other?: Other<"sendMediaGroup", "chat_id" | "media">, signal?: AbortSignal): Promise<(Message.PhotoMessage | Message.LivePhotoMessage | Message.AudioMessage | Message.DocumentMessage | Message.VideoMessage)[]>;
    /**
     ...
     */
    replyWithRichMessageDraft(rich_message: InputRichMessageWithoutUpload, other?: Other<"sendRichMessageDraft", "chat_id" | "rich_message">, signal?: AbortSignal): Promise<true>;
    /**
     ...
     */
    answerChatJoinRequestQuery(result: "approve" | "decline" | "queue", signal?: AbortSignal): Promise<true>;
    /**
     ...
     */
    replyWithChatJoinRequestWebApp(web_app_url: string, signal?: AbortSignal): Promise<true>;
    /**
     ...
     */
    editMessageText(text: string | InputRichMessage, other?: Other<"editMessageText", "chat_id" | "message_id" | "inline_message_id" | "text" | "rich_message">, signal?: AbortSignal): Promise<true | (Update.Edited & Message.CommonMessage & {
        text: string;
    } & Partial<{
        entities: MessageEntity[];
    }>) | (Update.Edited & Message.CommonMessage & {
     ...
     */
    editEphemeralMessageText(text_or_rich_message: string | InputRichMessage, other?: Other<"editEphemeralMessageText", "chat_id" | "receiver_user_id" | "ephemeral_message_id" | "text" | "rich_message">, signal?: AbortSignal): Promise<true>;
    /**
     ...
     */
    editEphemeralMessageMedia(media: InputMedia, other?: Other<"editEphemeralMessageMedia", "chat_id" | "receiver_user_id" | "ephemeral_message_id" | "media">, signal?: AbortSignal): Promise<true>;
    /**
     ...
     */
    editEphemeralMessageCaption(caption: string, other?: Other<"editEphemeralMessageCaption", "chat_id" | "receiver_user_id" | "ephemeral_message_id" | "caption">, signal?: AbortSignal): Promise<true>;
    /**
     ...
     * **Official reference:** https://core.telegram.org/bots/api#editephemeralmessagecaption
     */
    editEphemeralMessageReplyMarkup(other?: Other<"editEphemeralMessageReplyMarkup", "chat_id" | "receiver_user_id" | "ephemeral_message_id">, signal?: AbortSignal): Promise<true>;
    /**
     ...
     */
    deleteEphemeralMessage(signal?: AbortSignal): Promise<true>;
    /**
