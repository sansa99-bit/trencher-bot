...
export declare class Keyboard {
     ...
     */
    forceReply(isEnabled?: boolean): this;
    /**
...
export declare class InlineKeyboard {
     ...
     * @param text The text to display, and optional styling information
     */
    disabled(text: string | InlineKeyboardButton.AbstractInlineKeyboardButton): this;
    /**
     * Creates a new disabled button. It does nothing.
     *
     * @param text The text to display, and optional styling information
     */
    static disabled(text: string | InlineKeyboardButton.AbstractInlineKeyboardButton): InlineKeyboardButton.DisabledButtonButton;
    /**
     ...
     * used instead.
     */
    clone(inline_keyboard?: InlineKeyboardButton[][]): InlineKeyboard;
    /**
