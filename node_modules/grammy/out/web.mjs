...
class Context {
    ...
    get chat() {
        return (this.msg ?? this.deletedBusinessMessages ?? this.stoppedMessageGeneration ?? this.messageReaction ?? this.messageReactionCount ?? this.myChatMember ?? this.chatMember ?? this.chatJoinRequest ?? this.chatBoost ?? this.removedChatBoost)?.chat;
    }
    get senderChat() {
