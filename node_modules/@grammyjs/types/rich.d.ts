...
import type { CopyTextButton, DisabledButton, LoginUrl, SwitchInlineQueryChosenChat, WebAppInfo } from "./markup.js";
import type { Animation, Audio, Document, Location, PhotoSize, Video, Voice } from "./message.js";
import type { InputMediaAnimation, InputMediaAudio, InputMediaDocument, InputMediaPhoto, InputMediaVideo, InputMediaVoiceNote } from "./methods.js";
...
export interface InputRichMessageMedia<F> {
    ...
    media: InputMediaAnimation<F> | InputMediaAudio<F> | InputMediaDocument<F> | InputMediaPhoto<F> | InputMediaVideo<F> | InputMediaVoiceNote<F>;
}
...
export declare namespace RichMessageButton {
    ...
    interface UrlButton extends AbstractRichMessageButton {
        /** HTTP or tg:// URL to be opened when the button is pressed. Links tg://user?id=<user_id> can be used to mention a user by their identifier without using a username, if this is allowed by their privacy settings. */
        url: string;
    }
    interface CallbackButton extends AbstractRichMessageButton {
        /** Data to be sent in a callback query to the bot when the button is pressed, 1-64 bytes */
        callback_data: string;
    }
    interface WebAppButton extends AbstractRichMessageButton {
        /** Description of the Web App that will be launched when the user presses the button. The Web App will be able to send an arbitrary message on behalf of the user using the method answerWebAppQuery. Available only in private chats between a user and the bot. Not supported for messages sent on behalf of a business account. */
        web_app: WebAppInfo;
    }
    interface LoginUrlButton extends AbstractRichMessageButton {
    ...
    interface SwitchInlineButton extends AbstractRichMessageButton {
        /** If set, pressing the button will prompt the user to select one of their chats, open that chat and insert the bot's username and the specified inline query in the input field. May be empty, in which case just the bot's username will be inserted. Not supported for messages sent in channel direct messages chats and on behalf of a business account. */
        switch_inline_query: string;
    }
    interface SwitchInlineCurrentChatButton extends AbstractRichMessageButton {
    ...
    interface SwitchInlineQueryChosenChatButton extends AbstractRichMessageButton {
    ...
    interface CopyTextButtonButton extends AbstractRichMessageButton {
        /** A button that copies the specified text to the clipboard */
        copy_text: CopyTextButton;
    }
    interface DisabledButtonButton extends AbstractRichMessageButton {
...
export type RichMessageButton = RichMessageButton.UrlButton | RichMessageButton.CallbackButton | RichMessageButton.WebAppButton | RichMessageButton.LoginUrlButton | RichMessageButton.SwitchInlineButton | RichMessageButton.SwitchInlineCurrentChatButton | RichMessageButton.SwitchInlineQueryChosenChatButton | RichMessageButton.CopyTextButtonButton | RichMessageButton.DisabledButtonButton;
/** A button. */
