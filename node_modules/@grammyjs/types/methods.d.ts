...
import type { EphemeralMessageParameters, File, GameHighScore, LinkPreviewOptions, MaskPosition, Message, MessageEntity, MessageId, ParseMode, Poll, PreparedInlineMessage, ReactionType, ReplyParameters, SentGuestMessage, SentWebAppMessage, Sticker, StickerSet, Story, SuggestedPostParameters } from "./message.js";
...
import type { StoryArea } from "./story.js";
...
export type ApiMethods<F> = {
    ...
    sendMediaGroup(args: {
        ...
        media: ReadonlyArray<InputMediaAudio<F>> | ReadonlyArray<InputMediaDocument<F>> | ReadonlyArray<InputMediaLivePhoto<F> | InputMediaPhoto<F> | InputMediaVideo<F>>;
        /** Sends the messages silently. Users will receive a notification with no sound. */
        disable_notification?: boolean;
        /** Protects the contents of the sent messages from forwarding and saving */
        protect_content?: boolean;
    ...
    editMessageText(args: {
        ...
        /** An object for an inline keyboard */
        reply_markup?: InlineKeyboardMarkup;
    }): (Update.Edited & Message.TextMessage) | (Update.Edited & Message.RichMessageMessage) | true;
...
/** This object represents the content of a poll option to be sent. It should be one of
 ...
 - InputMediaVenue
 - InputMediaVideo */
export type InputPollOptionMedia<F> = InputMediaAnimation<F> | InputMediaLink | InputMediaLivePhoto<F> | InputMediaLocation | InputMediaPhoto<F> | InputMediaSticker<F> | InputMediaVenue | InputMediaVideo<F>;
